...
insert  into `tbl_configs`(`website_name`,`website_theme`,`website_language`,`update_by`,`update_time`) values ('DW/DM  Back-Office Management','3','th','Administrator','2014-07-17 09:27:24');
...
insert  into `tbl_menu_group`(`mgroup_id`,`menu_group_th`,`menu_group_en`,`menu_path`,`menu_order`,`icon_id`,`update_by`,`update_time`) values (1,'ผู้ดูแลระบบ','Administrator','Admin',1,2,'','2014-07-10 11:13:10'),(3,'ข้อมูลส่วนตัว','Profiles','Master',2,4,'Administrator','2014-07-10 11:13:05'),(8,'คู่มือการใช้งาน','User Manual','Manual',7,7,'Administrator','2014-07-10 11:13:03'),(9,'บริหารจัดองค์ความรู้','Knowledge Management','Main',3,9,'Administrator','2014-07-16 12:35:46'),(10,'DW/DM','DW/DM','DWDM',4,13,'Administrator','2014-07-10 09:55:31');
...
insert  into `tbl_user_auth`(`user_id`,`group_id`,`update_by`,`update_time`) values (7,1,'Adminstrator','2014-07-08 11:17:59'),(10,1,'Administrator','2014-07-16 12:41:33'),(2,3,'Adminstrator','2014-07-08 11:17:35');
