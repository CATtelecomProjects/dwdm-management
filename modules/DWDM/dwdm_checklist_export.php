...
$mpdf = new mPDF('th', 'A4-L', '0', '');   //การตั้งค่ากระดาษถ้าต้องการแนวตั้ง ก็ A4 เฉยๆครับ ถ้าต้องการแนวนอนเท่ากับ A4-L
        ...
        <body lang="th">
            ...
            <table width="100%" border="1" cellpadding="4" cellspacing="0"  style="border-collapse:collapse;overflow: wrap" class="tborder">
                <thead class="ui-widget-header">
                    <th width="15%" height="17" bgcolor="#999999">วันที่</th>
                    <th colspan="3" bgcolor="#999999">รายการ</th>
                    <th width="21%" bgcolor="#999999">ปัญหา / อาการ    -  แก้ไข</th>
                ...
                for ($i = 0; $i < count($rs_data); $i++) {
                    ...
                    <tr>
                        <td rowspan="8" ><?= $rs_data[$i]['holiday'] == "Y" ? "&nbsp;<img src='./images/icons-holiday.png' align='absmiddle'> (" . $rs_data[$i]['remarks'] . ")<br />" : "" ?>
                            &nbsp;<strong>วันที่ : </strong><u><?= $check_date_str ?></u><br />
                        ...
                        <td width="17%" valign="top" bgcolor="#E4E4E4" class="ui-state-default"><strong>หมายเหตุ :</strong></td>
                    </tr>
                    <tr>
