...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="display compact" id="<?= $tbl->id; ?>">
    <thead>
        <tr>
            ...
            <th width="24%">ชื่อ Portlet</th>
            <th width="31%">ปรับปรุงโดย</th>
            <th width="23%">วันที่ปรับปรุงล่าสุด</th>
            <th width="13%">แสดง</th>
        </tr>
    </thead>
    <tbody>
<?php for ($i = 0; $i < count($rs_list); $i++) { ?>
            <tr>
                ...
                <td align="center"><?= $rs_list[$i]['portlet'] ?></td>
                <td align="center"><?= $rs_list[$i]['update_by'] ?></td>
                <td align="center"><?= $rs_list[$i]['update_time']; ?></td>
                <td align="center"><button name="preview" class="preview" value="<?= $rs_list[$i]['portlet'] ?>">View</button></td>
            </tr>
<?php } // End For  ?>
    </tbody>
</table>
