...
if ($_GET['doAction'] == "edit") {
    $id = $_GET['id'];
    $sql_edit = "SELECT * FROM tbl_sm_module WHERE  module_name = '$id' ";
...
<form id="form_<?= $_GET['pages'] ?>" name="form_<?= $_GET['pages'] ?>" method="post" action="">
    <table width="100%" border="0" cellspacing="1" cellpadding="1">
        <tr>
            <td width="5%">&nbsp;</td>
            <td width="95%" colspan="2"><strong>*Module Name :</strong><br>
        ...
        <tr>
            <td>&nbsp;</td>
            <td colspan="2"><strong>Module Description :</strong><br>
