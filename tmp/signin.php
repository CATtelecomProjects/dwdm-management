...
$(function(){
	...
	$("#username,#password,#captcha").tipsy({trigger: "hover",gravity: "w"});	
    ...
    <table width="100%" border="0" align="center" cellpadding="1" cellspacing="0">
      <tr>
        <td><table width="100%" border="0" align="center" cellpadding="4" cellspacing="0">
            <tr>
              <td width="12%" rowspan="6" align="center" valign="top"><img src="images/login_new.png"></td>
...
var sprytextfield3 = new Spry.Widget.ValidationTextField("sprytextfield3", "integer", {validateOn:["blur", "change"], minChars:4, maxChars:4});
</script>
</body>
</html>